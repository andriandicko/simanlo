<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0" href="/dashboard">
            <span class="font-weight-bold text-lg">SIMANLO</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">

        {{-- Auth Role On Sidebar --}}
        @if (Auth::user()->role_id == 1)
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('produks', 'produk/create', 'produk/edit') ? 'active' : '' }}"
                        href="/produks">
                        <div
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ Request::is('pesanans', 'pesanan/create', 'pesanan/edit') ? 'active' : '' }}"
                        href="/pesanans">
                        <div
                            class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                            <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ Request::is('pemasoks', 'pemasoks/create', 'pemasoks/edit') ? 'active' : '' }}"
                        href="/pemasoks">
                        <div
                            class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                            <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ Request::is('pelanggans', 'pelanggan/create', 'pelanggan/edit') ? 'active' : '' }}"
                        href="/pelanggans">
                        <div
                            class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                            <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ Request::is('gudangs', 'gudang/create', 'gudang/edit') ? 'active' : '' }}"
                        href="/gudangs">
                        <div
                            class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <g id="rtl" stroke="none" stroke-width="1" fill="none"
                                    ...
                                    <g id="menu-alt-3" transform="translate(12.000000, 14.000000)" fill="#FFFFFF">
                                        <path class="color-background"
                                            d="M480 0c-17.7 0-32 14.3-32 32V192 512h64V192H624c8.8 0 16-7.2 16-16V48c0-8.8-7.2-16-16-16H512c0-17.7-14.3-32-32-32z"id="Path" />
                                        <path class="color-foreground"
                                            d="M416 159L276.8 39.7c-12-10.3-29.7-10.3-41.7 0l-224 192C1 240.4-2.7 254.5 2 267.1S18.6 288 32 288H64V480c0 17.7 14.3 32 32 32h64c17.7 0 32-14.3 32-32V384c0-17.7 14.3-32 32-32h64c17.7 0 32 14.3 32 32v96c0 17.7 14.3 32 32 32h64.7l.2 0h-1V159z "id="Path" />
                            ...
                            <div
                                ...
                                <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                                    ...
                                    <g id="wallet" stroke="none" stroke-width="1" fill="none"
                                        fill-rule="evenodd">
                                        <g id="credit-card" transform="translate(12.000000, 15.000000)"
                                            fill="#FFFFFF">
                                            <path class="color-background"
                                                d="M3,0 C1.343145,0 0,1.343145 0,3 L0,4.5 L24,4.5 L24,3 C24,1.343145 22.6569,0 21,0 L3,0 Z"
                                                id="Path" fill-rule="nonzero"></path>
