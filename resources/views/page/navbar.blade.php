    ...
    <div class="container-fluid px-1">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="navbar-nav mx-auto ms-xl-auto">
          {{-- <li class="nav-item">
            <a class="nav-link d-flex align-items-center me-2 " aria-current="page" href="/dashboard">
          ...
          <li class="nav-item">
            <a class="nav-link d-flex align-items-center me-2 {{ Request::is('signup') ? 'text-dark' : '' }} " href="/signup">
              <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="opacity-6 me-1">
          ...
          <li class="nav-item">
            <a class="nav-link d-flex align-items-center me-2 {{ Request::is('signin') ? 'text-dark' : '' }}" href="/signin">
              <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="opacity-6 me-1">
