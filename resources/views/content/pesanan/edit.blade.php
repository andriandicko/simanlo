                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Edit Pesanan</h6>
                                    <p class="text-sm">Edit Data Barang Pesanan</p>
                                </div>
                        ...
                        <div class="card-body px-0 py-0">
                            <div class="table-responsive p-0">
                                ...
                                <form class="mx-3 my-5" method="POST" action="/pesanan">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                <label for="example-number-input" class="form-control-label">Tanggal Pesanan</label>
                                                <input class="form-control" type="date" value=" "
                                                    id="example-number-input">
                                            </div>

                                            <div class="form-group">
                                                <label for="example-number-input" class="form-control-label">Tanggal Pengiriman</label>
                                                <input class="form-control" type="date" value=" "
                                                    id="example-number-input">
                                            </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="exampleFormControlSelect1">
                                                    <option>PT. Indofood Tbk</option>
                                                    <option>PT. Tirta Jaya</option>
                                                </select>
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleFormControlSelect1">Nama Gudang</label>
                                                <select class="form-control" id="exampleFormControlSelect1">
                                                    <option>Gudang Indofood </option>
                                                    <option>Gudang Tirta </option>
                                                </select>
                                            </div>
